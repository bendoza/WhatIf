...
1. Figure out why Top 3 Outperformers only works after second calculate click.
...
4. Print to the UI something like "Select your Portfolio" above the crypto selector
...
7. Update README to consider .env file that contains UFL CISE Oracle Database information, and to consider the Gatorlink VPN connection for the DB.